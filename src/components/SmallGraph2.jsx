...
const percentageData = [
  { name: "active", value: 19, fill: "#E2E6FF" },
      ...
      <PieChart>
        <defs>
          ...
          <linearGradient id="color2Gradient" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#9EC600" stopOpacity={0.6}/>
            <stop offset="100%" stopColor="#E2E6FF" stopOpacity={1}/>
          </linearGradient>
          <linearGradient id="color4Gradient" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#6E81FE" stopOpacity={2}/>
            <stop offset="100%" stopColor="#FFB7F5" stopOpacity={1}/>
          </linearGradient>
        </defs>
        <ChartTooltip />
        <Pie 
        ...
        <Pie
          data={percentageData.map(item => ({
            ...item,
            fill: item.name === "active" ? "url(#color4Gradient)" : "#FFFFFF"
          }))}
          dataKey="value"
          innerRadius={28}
          outerRadius={36}
